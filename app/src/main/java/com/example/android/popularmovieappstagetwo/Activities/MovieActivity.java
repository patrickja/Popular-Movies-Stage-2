...
import com.example.android.popularmovieappstagetwo.Adapters.MovieAdapter;
...
import com.example.android.popularmovieappstagetwo.Models.MainViewModel;
...
import static com.example.android.popularmovieappstagetwo.Models.Constants.SORT_FAVORITE;
import static com.example.android.popularmovieappstagetwo.Models.Constants.SORT_POPULAR;
import static com.example.android.popularmovieappstagetwo.Models.Constants.SORT_TOP_RATED;
...
public class MovieActivity extends AppCompatActivity implements MovieAdapter.ListItemClickListener {
        ...
        private List<Favorites> favMovs;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            favMovs = new ArrayList<Favorites>();
        ...
        private void makeMovieSearchQuery() {
            if (currentSort.equals(SORT_FAVORITE)) {
                ...
                URL movieSearchUrl = NetworkUtils.buildUrl(movieQuery, Constants.apiKey);
        ...
        private void setupViewModel() {
            ...
            viewModel.getMovies().observe(this, new Observer<List<Favorites>>() {
                @Override
                public void onChanged(@Nullable List<Favorites> favs) {
                    if(favs.size()>0) {
                        favMovs.clear();
                        favMovs = favs;
                    }
